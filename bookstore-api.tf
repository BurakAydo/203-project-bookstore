...
provider "aws" {
  region = "us-east-1"
  profile = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
}
...
resource "aws_instance" "docker-ec2" {
    ...
    key_name = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
    ...
    user_data = <<-EOF
        ...
        TOKEN="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        FOLDER="https://$TOKEN@raw.githubusercontent.com/BurakAydo/bookstore-api-project/main/"
        ...
        docker build -t babaydar/bookstoreapi:latest .
        docker-compose up -d
        EOF
